...
/**
 * Fetch Twitter jobs based on search criteria
 * @param req - Express request object with search parameters in body
 * @param res - Express response object
 */
export const getTwitterJobs = async (
  req: Request,
  res: Response
): Promise<void> => {
  try {
    ...
    const response: ApiResponse<typeof twitterJobs> = {
      success: true,
      data: twitterJobs,
    };
...
/**
 * Fetch Twitter job details by job ID
 * @param req - Express request object with jobId and loggedIn in body
 * @param res - Express response object
 */
export const getTwitterJobById = async (
  req: Request,
  res: Response
): Promise<void> => {
  try {
    ...
    const response: ApiResponse<typeof jobDetails> = {
      success: true,
      data: jobDetails,
    };
    res.status(200).json(response);
